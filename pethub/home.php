...
<div class="home-top-text">
  ...
  <ul class="carousel">
    ...
    <li class="item"><img class src="/pethub/img/image.png"></li>
    <li class="item"><img class src="/pethub/img/image1.png"></li>
    <li class="item"><img class src="/pethub/img/image2.png"></li>
  </ul>
